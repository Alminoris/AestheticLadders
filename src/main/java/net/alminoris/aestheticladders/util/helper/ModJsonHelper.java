...
public class ModJsonHelper
{
    ...
    public static void createStonecuttingRecipe(String ingredientName, String outputName, String count)
    {
        ...
        String filePath = projectPath.replace("build\\datagen", "src\\main\\resources") + "/data/"+ AestheticLadders.MOD_ID+"/recipes/";
    ...
    public static void createBlockstate(String jsonContent, String name)
    {
        ...
        String filePath = projectPath.replace("build\\datagen", "src\\main\\resources") + "/assets/"+ AestheticLadders.MOD_ID+"/blockstates/";
