...
{
    public ModLanguageProviderUkUa(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture)
    {
        super(output, "uk_ua", registriesFuture);
    }
